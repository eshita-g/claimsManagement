...
<br>
<table>
 <tr><th> Date Of Accident</th></tr> <tr><td> <input type="text" name="doA" placeholder="YYYY-MM-DD" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" title="Enter a date in this formart YYYY-MM-DD"/></td>
</tr>
</table>
<hr>
<table>
